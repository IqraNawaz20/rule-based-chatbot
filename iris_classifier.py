...
# (Randomize/shuffle before splitting to remove order bias)
# ---------------------------------------------------------
...
# ---------------------------------------------------------
# STEP 2b: Feature Scaling (Gatekeeper Rule)
...
new_flower = [[5.0, 3.4, 1.5, 0.2]] # sepal_len, sepal_wid, petal_len, petal_wid
